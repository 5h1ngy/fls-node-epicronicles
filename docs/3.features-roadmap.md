...
* **Fase 0** â€“ completata: architettura React/Three + store globale (ora Redux Toolkit) e loop simulazione funzionanti.
* **Fase 1** â€“ completata: vertical slice di esplorazione con fog-of-war, navi scientifiche controllabili e mappa interattiva.
* **Fase 2** â€“ in progresso: colonie e risorse base funzionano, restano distretti e popolazione avanzata.
* **Fasi 3+** â€“ non avviate.

---

## Fase 0 â€“ Fondamenta tecniche

**Stato 0.1.0-alpha:** âœ”ï¸ completata (UI modulare, loop simulazione, Redux Toolkit + pannelli debug).
...
## Fase 1 â€“ Galassia + Esplorazione (vertical slice iniziale)

**Stato 0.1.0-alpha:** âœ”ï¸ completata (mappa top-down, focus camera, fog-of-war, pannelli overview/colonie/sistema).
...
* Pianeti colonizzabili:
  ...
  * Nave colonia come unitÃ  costruibile o iniziale (RF-IMP-PLA-02).
   * [x] Ordine “colonizza pianeta” con selezione pianeta valido e coda lavori.
...
1. **Colonizzazione giocabile end-to-end**
   * [x] Implementare nave colonia iniziale + produzione in cantiere.
   * [x] Ordine “colonizza pianeta” con selezione pianeta valido e coda lavori.
   * [x] Aggiornare HUD/ColonyPanel per mostrare stati (in viaggio, colonizzazione, completato).
2. **Distretti e produzione risorse**
   * âœ… Esporre nel dettaglio pianeta produzione netta (district + popolazione) con breakdown.
...
5. **UX pannelli economia**
   * [x] Inserire timeline costruzioni (Gantt semplice) e quick actions (annulla, priorita).
   * [x] Migliorare readability delle card risorse con indicatori di surplus/deficit per tick.
